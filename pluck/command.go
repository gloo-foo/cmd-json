...
func pluckFields(obj map[string]jsoncmd.Value, fields []string) map[string]jsoncmd.Value {
...
func pluck(fields []string) jsoncmd.Processor {
...
func Pluck(fields ...string) gloo.Command[[]byte, []byte] {
